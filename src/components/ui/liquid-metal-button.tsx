...
export function LiquidMetalButton({
  ...
  useEffect(() => {
    ...
    if (!document.getElementById(styleId)) {
      ...
      style.id = styleId
      style.textContent = `
.liquid-metal-shader canvas { width: 100% !important; height: 100% !important; display: block !important; position: absolute !important; inset: 0 !important; border-radius: 100px !important; }
      ...
      >
        ...
        >
          ...
          >
            <div
              ref={shaderRef}
              className={subtle ? "liquid-metal-button-subtle" : undefined}
              style={{
            ...
            <div
              style={{
                ...
                boxShadow: isPressed
                  ...
                  : isHovered
                    ? subtle
                      ? "0px 0px 0px 1.5px rgba(255, 255, 255, 0.18), 0px 15px 30px 0px rgba(0, 0, 0, 0.5), 0px 0px 16px rgba(255, 255, 255, 0.12)"
                      : "0px 0px 0px 1.5px rgba(255, 255, 255, 0.4), 0px 15px 30px 0px rgba(0, 0, 0, 0.5), 0px 0px 25px rgba(255, 255, 255, 0.35)"
                    : subtle
                      ? "0px 0px 0px 1px rgba(255, 255, 255, 0.1), 0px 10px 20px 0px rgba(0, 0, 0, 0.3)"
              ...
              {isHovered && (
                <div
                  style={{
                    ...
                    borderRadius: "100px",
                    background:
                      `linear-gradient(90deg, transparent 0%, rgba(255,255,255,${subtle ? 0.16 : 0.4}) 50%, transparent 100%)`,
